    ...
    return __awaiter(this, void 0, Promise, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, pdf_parser_1.normalizeText(result.value)];
                case 2:
                    error_1 = _a.sent();
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var contentType, data, candidateData, candidateId, cvData, cvId, completeCV, formData, file, jobPositionId_1, fileInfo, validTypes, buffer, cvText, fileUrl, jobPositions, jobPosition, selectedPosition, analysis, candidateData, candidateId, cvData, cvId, completeCV, error_2, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    candidateData = {
                        ...
                        skills: data.skills.split(',').map(function (skill) { return skill.trim(); }),
                        title: '',
                        location: '',
                        birthDate: '',
                        age: 0,
                ...
                case 5: return [4 /*yield*/, request.formData()];
                case 6:
                    formData = _a.sent();
                ...
                case 8:
                    buffer = _a.sent();
                    cvText = '';
                    if (!(file.type === 'application/pdf')) return [3 /*break*/, 10];
                    console.log('Procesando archivo PDF...');
                    return [4 /*yield*/, pdf_parser_1.parsePDF(buffer)];
                case 9:
                    cvText = _a.sent();
                    return [3 /*break*/, 12];
                case 10:
                    if (!(file.type === 'application/vnd.openxmlformats-officedocument.wordprocessingml.document')) return [3 /*break*/, 12];
                    console.log('Procesando archivo DOCX...');
                    return [4 /*yield*/, extractTextFromDOCX(buffer)];
                case 11:
                    cvText = _a.sent();
                    _a.label = 12;
                case 12:
                ...
                case 14:
                    ...
                    return [4 /*yield*/, openai_1.analyzeCVWithGPT(cvText, jobPosition)];
                case 15:
                    analysis = _a.sent();
...
function DELETE(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, cvId, app, db, cvRef, cvSnap, cvData, error_6, fileError, error_7;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 9, , 10]);
                    ...
                    return [4 /*yield*/, firestore_1.getDoc(cvRef)];
                case 1:
                    cvSnap = _a.sent();
                    if (!cvSnap.exists()) return [3 /*break*/, 7];
                    cvData = cvSnap.data();
                    console.log("CV encontrado con ID: " + cvId);
                    if (!cvData.fileUrl) return [3 /*break*/, 5];
                    console.log("CV tiene fileUrl: " + cvData.fileUrl);
                    if (!cvData.fileUrl.includes('example.com')) return [3 /*break*/, 2];
                ...
                case 2:
                    ...
                    return [4 /*yield*/, safeDeleteStorageFile(cvData.fileUrl, app)];
                case 3:
                    // Intentar eliminar el archivo pero no bloquear el proceso si falla
                    _a.sent();
                    return [3 /*break*/, 5];
                ...
                return [4 /*yield*/, firestore_1.deleteDoc(cvRef)];
                case 6:
                    // Eliminar el documento de CV directamente
                    _a.sent();
                ...
                case 9:
                    error_7 = _a.sent();
                    console.error('Error al eliminar CV:', error_7);
                    return [2 /*return*/, server_1.NextResponse.json({
                            success: false,
                            error: 'Error al eliminar CV',
                            details: error_7 instanceof Error ? error_7.message : 'Error desconocido'
                        }, { status: 500 })];
...
function safeDeleteStorageFile(fileUrl, app) {
    return __awaiter(this, void 0, Promise, function () {
        var segments, pathWithQuery, path, decodedPath, storage, fileRef, error_8;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                ...
                case 2:
                    error_8 = _a.sent();
                    console.log('Error al eliminar archivo (ignorado):', error_8);
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
